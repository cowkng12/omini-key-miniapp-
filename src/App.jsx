...
const translations = {
  ru: {
    ...
    productText: {
      ...
      'chatgpt-team-seat': ['Team', 'Место в ChatGPT Team для работы, кода и командных задач.'],
      'grok-premium': ['AI чат', 'Доступ к Grok для быстрых ответов, идей и повседневных задач.'],
      'grok-premium-plus': ['Максимум', 'Расширенный Grok для частого использования и большего запаса лимитов.'],
      'grok-ready-account': ['Готовый аккаунт', 'Готовый аккаунт Grok для быстрого старта без лишней настройки.'],
      'grok-duo': ['2 аккаунта', 'Два аккаунта Grok по выгодной цене для себя и друга.'],
  ...
  en: {
    ...
    productText: {
      ...
      'chatgpt-team-seat': ['Team', 'ChatGPT Team seat for work, coding and team tasks.'],
      'grok-premium': ['AI chat', 'Access to Grok for quick answers, ideas and daily tasks.'],
      'grok-premium-plus': ['Maximum', 'Extended Grok access for frequent use and more limits.'],
      'grok-ready-account': ['Ready account', 'Ready Grok account for a fast start without extra setup.'],
      'grok-duo': ['2 accounts', 'Two Grok accounts at a friendly price for you and a friend.'],
  ...
  zh: {
    ...
    productText: {
      ...
      'chatgpt-team-seat': ['团队席位', '适合工作、编程和团队任务的 ChatGPT Team 席位。'],
      'grok-premium': ['AI 聊天', '使用 Grok 获取快速回答、想法和日常帮助。'],
      'grok-premium-plus': ['更高额度', '适合高频使用和更多额度的 Grok 扩展访问。'],
      'grok-ready-account': ['现成账号', '现成 Grok 账号，无需复杂设置即可开始。'],
      'grok-duo': ['2 个账号', '两个 Grok 账号，适合自己和朋友一起使用。'],
