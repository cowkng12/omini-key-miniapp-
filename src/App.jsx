...
const translations = {
  ru: {
    ...
    productText: {
      ...
      'gemini-pro': ['Google AI', 'Базовый доступ Gemini для текстов, учебы и быстрых задач.'],
      'gemini-advanced': ['Google AI', 'Gemini Advanced для текста, анализа, учебы и быстрых идей.'],
      'gemini-ultra': ['Ultra', 'Расширенный Gemini для сложных задач, анализа и креатива.'],
      'gemini-workspace-business': ['Workspace', 'Gemini для Gmail, Docs, Sheets и рабочих процессов Google.'],
      'gemini-workspace-enterprise': ['Enterprise', 'Больше возможностей Gemini Workspace для команд и бизнеса.'],
      'gemini-api-pack': ['API', 'Пакет доступа Gemini API для тестов, интеграций и разработки.'],
  ...
  en: {
    ...
    productText: {
      ...
      'gemini-pro': ['Google AI', 'Basic Gemini access for writing, study and quick tasks.'],
      'gemini-advanced': ['Google AI', 'Gemini Advanced for writing, analysis, study and ideas.'],
      'gemini-ultra': ['Ultra', 'Extended Gemini for complex tasks, analysis and creative work.'],
      'gemini-workspace-business': ['Workspace', 'Gemini for Gmail, Docs, Sheets and Google workflows.'],
      'gemini-workspace-enterprise': ['Enterprise', 'More Gemini Workspace capabilities for teams and business.'],
      'gemini-api-pack': ['API', 'Gemini API access pack for tests, integrations and development.'],
  ...
  zh: {
    ...
    productText: {
      ...
      'gemini-pro': ['Google AI', 'Gemini 基础访问，适合写作、学习和快速任务。'],
      'gemini-advanced': ['Google AI', 'Gemini Advanced，适合写作、分析、学习和想法。'],
      'gemini-ultra': ['Ultra', '更高阶 Gemini，适合复杂任务、分析和创意工作。'],
      'gemini-workspace-business': ['Workspace', '适用于 Gmail、Docs、Sheets 和 Google 工作流的 Gemini。'],
      'gemini-workspace-enterprise': ['Enterprise', '适合团队和业务的更多 Gemini Workspace 能力。'],
      'gemini-api-pack': ['API', 'Gemini API 访问包，适合测试、集成和开发。'],
