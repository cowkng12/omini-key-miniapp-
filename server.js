  ...
  const botText = {
    ru: {
      ...
      welcome: (name) => [
        ...
        '',
        'Что внутри:',
        '• каталог популярных нейросервисов с иконками:',
        '  🤖 ChatGPT — Plus, Go, Pro, Business',
        '  🧠 Claude — Pro, 2 Accounts Pro, Max',
        '  💻 Cursor — Pro, 2 Accounts Pro, Ultra',
        '  🔎 Perplexity, Gemini, Copilot',
        '  🎨 Midjourney, Runway, Kling, Leonardo AI',
        '  🎧 Suno, ElevenLabs, Canva, Notion AI, Poe',
        '',
        'Популярные лоты:',
        '🤖 ChatGPT Plus Ready — $1.5',
        '🤖 ChatGPT Pro Ready — $60',
        '🧠 Claude Pro — $10',
        '🧠 Claude 2 Accounts Pro — $18',
        '💻 Cursor Pro — $10',
        '💻 Cursor 2 Accounts Pro — $18',
        '🔎 Perplexity Pro — $10',
        '💎 Gemini Pro — $5',
        '🎨 Midjourney Basic — $5',
        '🎵 Suno Pro — $5',
    ...
    en: {
      ...
      welcome: (name) => [
        ...
        '',
        'Inside:',
        '• popular AI services with icons:',
        '  🤖 ChatGPT — Plus, Go, Pro, Business',
        '  🧠 Claude — Pro, 2 Accounts Pro, Max',
        '  💻 Cursor — Pro, 2 Accounts Pro, Ultra',
        '  🔎 Perplexity, Gemini, Copilot',
