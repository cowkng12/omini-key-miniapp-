...
if (botToken) {
  ...
  const botText = {
    ...
    en: {
      ...
      about: '💠 About\n\nOminiKey Store helps you buy subscriptions for popular AI services quickly.',
      shop: '🛍 Open catalog',
    ...
    zh: {
      ...
      about: '💠 关于项目\n\nOminiKey Store 帮助你快速购买热门 AI 服务订阅。',
      shop: '🛍 打开目录',
      guideButton: '📘 如何购买',
      ordersButton: '🧾 我的购买',
      promotionsButton: '🎁 优惠',
